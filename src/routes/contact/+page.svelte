...
<div>
  ...
  <textarea name="message" placeholder="留言" rows="10" required class="p-2 bg-zinc-50 "></textarea>
      <button class="max-w-max px-2 py-1cursor-pointer bg-teal-900 text-teal-50">提交</button>
    </form>
